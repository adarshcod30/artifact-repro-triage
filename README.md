...
|---|---|---|---|
| 1 | Solution code **+ Improvement Changelog** | [`src/`](src/) · [`CHANGELOG.md`](CHANGELOG.md) — 157 iterations, each an evidence-driven decision, closing with the main failure mode and the hot take | Complete |
...
```bash
make test          # 237 regression tests, no credentials, ~1s
