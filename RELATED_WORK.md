...
|---|---|
| **Prevalence in *research artifacts* specifically** — 732 artifacts, 6,740 documented file references, 56.7% carrying at least one broken claim | Tan et al. measure general OSS; READU measures detection on a commit sample, not population prevalence. Neither reports a rate for research artifacts. |
