...
identical across all trials (`eval/negative_control.py`), and 230 regression tests
...
Total model spend is **$6.94** against a $7.00 ceiling. Pushing work *out* of the model made the system
