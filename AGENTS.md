...
identical across all trials (`eval/negative_control.py`), and 89 regression tests
...
Total model spend is **$3.87** against a $5 ceiling. Pushing work *out* of the model made the system
