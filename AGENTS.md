...
identical across all trials (`eval/negative_control.py`), and 117 regression tests
...
Total model spend is **$4.43** against a $5 ceiling. Pushing work *out* of the model made the system
