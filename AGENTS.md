...
identical across all trials (`eval/negative_control.py`), and 169 regression tests
...
Total model spend is **$6.10** against a $6.25 ceiling. Pushing work *out* of the model made the system
