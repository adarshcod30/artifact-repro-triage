...
identical across all trials (`eval/negative_control.py`), and 133 regression tests
...
Total model spend is **$4.92** against a $5 ceiling. Pushing work *out* of the model made the system
