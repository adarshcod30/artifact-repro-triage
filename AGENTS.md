...
identical across all trials (`eval/negative_control.py`), and 82 regression tests
...
Total model spend is **$3.80** against a $5 ceiling. Pushing work *out* of the model made the system
