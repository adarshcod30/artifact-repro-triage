...
identical across all trials (`eval/negative_control.py`), and 101 regression tests
...
Total model spend is **$3.94** against a $5 ceiling. Pushing work *out* of the model made the system
